...
test.describe('Positive flows', () => {
  test('TC-001: New todo appears in the list after creation', { tag: '@smoke' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-002: Todo is marked as completed when its checkbox is toggled', { tag: '@sanity' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-003: Todo is removed from the list when deleted', { tag: '@sanity' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-004: Multiple todos can be created independently in one session', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-005: Completed todo can be toggled back to active', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
...
test.describe('Negative flows', () => {
  test('TC-006: Empty todo is not added to the list', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-007: Whitespace-only todo is not added to the list', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-008: Deleting one todo does not remove other todos', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-009: Completing one todo does not mark other todos as completed', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-010: Deleted todo cannot be interacted with', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
...
test.describe('Edge cases', () => {
  test('TC-011: Todo text with special characters is stored and displayed literally', { tag: '@regression' }, async ({
    page,
  }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-012: Duplicate todo titles are both retained in the list', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
    await todoPage.addTodo('Buy milk');
    await todoPage.addTodo('Buy milk');
  ...
  test('TC-013: Very long todo text is accepted and displayed', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-014: Todo with leading and trailing spaces is normalized on save', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-015: Unicode and emoji characters are preserved in todo text', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-016: Deleting the last todo hides the footer and filters', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
  ...
  test('TC-017: New todo input is cleared after successful creation', { tag: '@regression' }, async ({ page }) => {
    const todoPage = new TodoMvcPage(page);
